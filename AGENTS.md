...
Read `.agents/design.md` before changing CLI output or visual media.
...
```text
branch:  vl-<issue>-<slug>          vl-142-fix-onboarding-drop-off
title:   [VL-<issue>] <Subject>   [VL-142] Fix onboarding drop-off
body:    Closes #142
